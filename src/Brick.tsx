        ...
        for (let i = 0; i < this.props.props.length; i++) {
            if (this.props.props[i].authenticated) {
                                ...
                                if (isSignedIn === true) {
                                    return (
                                        <Link key={`${this.props.props[i].name.toLowerCase()}.Link`}
                                            to={this.props.props[i].href || this.props.props[i].name.toLowerCase().replace(' ', '-')} style={{ textDecoration: 'none', color: 'inherit' }}>
                ...
                group.push(<Link key={`${this.props.props[i].name.toLowerCase()}.Link`}
                    to={this.props.props[i].href || this.props.props[i].name.toLowerCase().replace(' ', '-')}>
